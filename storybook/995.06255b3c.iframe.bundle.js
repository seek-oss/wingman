"use strict";(self.webpackChunkwingman_fe=self.webpackChunkwingman_fe||[]).push([[995],{"./src/components/ApolloMockProvider/ApolloMockProvider.tsx"(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{f:()=>ApolloMockProvider});var ApolloClient=__webpack_require__("../node_modules/.pnpm/@apollo+client@4.1.7_graphql-ws@6.0.8_graphql@16.14.2_ws@8.20.0__graphql@16.14.2_react-_b89b8672900e1d3538891c02ebb9457f/node_modules/@apollo/client/core/ApolloClient.js"),inMemoryCache=__webpack_require__("../node_modules/.pnpm/@apollo+client@4.1.7_graphql-ws@6.0.8_graphql@16.14.2_ws@8.20.0__graphql@16.14.2_react-_b89b8672900e1d3538891c02ebb9457f/node_modules/@apollo/client/cache/inmemory/inMemoryCache.js"),link_schema=__webpack_require__("../node_modules/.pnpm/@apollo+client@4.1.7_graphql-ws@6.0.8_graphql@16.14.2_ws@8.20.0__graphql@16.14.2_react-_b89b8672900e1d3538891c02ebb9457f/node_modules/@apollo/client/link/schema/index.js"),ApolloProvider=__webpack_require__("../node_modules/.pnpm/@apollo+client@4.1.7_graphql-ws@6.0.8_graphql@16.14.2_ws@8.20.0__graphql@16.14.2_react-_b89b8672900e1d3538891c02ebb9457f/node_modules/@apollo/client/react/context/ApolloProvider.js"),makeExecutableSchema=__webpack_require__("../node_modules/.pnpm/@graphql-tools+schema@10.0.32_graphql@16.14.2/node_modules/@graphql-tools/schema/esm/makeExecutableSchema.js");const readNestedStringField=(readField,fieldPath,from)=>{let field=from;for(const fieldName of fieldPath)field=readField(fieldName,field);return"string"==typeof field?field:void 0},infiniteScrollConnection=keyFields=>({fields:{edges:{merge:(existing,rawIncoming,_ref)=>{let{mergeObjects,readField,variables}=_ref;const reversed=Boolean(variables?.last),merged=existing?.slice(0)??[],keyToIndex=Object.create(null),fieldPath=["node",...Array.isArray(keyFields)?keyFields:[keyFields,"value"]];existing?.forEach((edge,index)=>{const key=readNestedStringField(readField,fieldPath,edge);key&&(keyToIndex[key]=index)});return(reversed?rawIncoming.slice(0).reverse():rawIncoming).forEach(edge=>{const key=readNestedStringField(readField,fieldPath,edge);if(!key)return;const index=keyToIndex[key];"number"==typeof index?merged[index]=mergeObjects(merged[index],edge):(keyToIndex[key]=merged.length,merged.push(edge))}),merged}}}}),seekApiEdge=keyFields=>({keyFields:["node",Array.isArray(keyFields)?keyFields:[keyFields,["value"]]]}),seekApiObject=keyFields=>({keyFields:Array.isArray(keyFields)?keyFields:[keyFields,["value"]]}),apolloTypePolicies=function(){let{paginationPolicy="conservative"}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};const paginationKeyArgs="conservative"===paginationPolicy?["after","before","first","last"]:["first","last"],seekApiConnection="conservative"===paginationPolicy?()=>({}):infiniteScrollConnection;return{AdvertisementBranding:seekApiObject("id"),AdvertisementBrandingEdge:seekApiEdge("id"),AdvertisementBrandingsConnection:seekApiConnection("id"),ApplicationQuestionnaire:seekApiObject("id"),Candidate:seekApiObject("documentId"),CandidateProcessHistoryItem:seekApiObject("id"),CandidateProcessHistoryItemEdge:seekApiEdge("id"),CandidateProcessHistoryItemConnection:seekApiConnection("id"),CandidateProfile:{...seekApiObject("profileId"),fields:{seekProcessHistory:{keyArgs:paginationKeyArgs}}},Event:seekApiObject("id"),EventEdge:seekApiEdge("id"),EventsConnection:seekApiConnection("id"),HiringOrganization:seekApiObject("id"),HiringOrganizationEdge:seekApiEdge("id"),HiringOrganizationsConnection:seekApiConnection("id"),JobCategory:seekApiObject("id"),Location:seekApiObject("id"),PositionOpening:seekApiObject("documentId"),PositionOpeningEdge:seekApiEdge("documentId"),PositionOpeningsConnection:seekApiConnection("documentId"),PositionProfile:seekApiObject("profileId"),Query:{fields:{advertisementBrandings:{keyArgs:["filter","hirerId",...paginationKeyArgs]},events:{keyArgs:["filter","schemeId",...paginationKeyArgs]},hiringOrganizations:{keyArgs:["filter","schemeId",...paginationKeyArgs]},positionOpenings:{keyArgs:["filter","hirerId",...paginationKeyArgs]},webhookAttemptsForEvent:{keyArgs:["eventId","filter",...paginationKeyArgs]},webhookRequestsForSubscription:{keyArgs:["filter","subscriptionId",...paginationKeyArgs]},webhookSubscriptions:{keyArgs:["filter","schemeId",...paginationKeyArgs]}}},WebhookAttempt:seekApiObject("id"),WebhookRequest:seekApiObject(["requestId"]),WebhookRequestEdge:seekApiEdge(["requestId"]),WebhookRequestsConnection:seekApiConnection(["requestId"]),WebhookSubscription:{...seekApiObject("id"),fields:{webhookRequests:{keyArgs:["filter",...paginationKeyArgs]},webhookSubscriptionReplays:{keyArgs:["filter",...paginationKeyArgs]}}},WebhookSubscriptionEdge:seekApiEdge("id"),WebhookSubscriptionsConnection:seekApiConnection("id"),WebhookSubscriptionReplay:seekApiObject("id"),WebhookSubscriptionReplayEdge:seekApiEdge("id"),WebhookSubscriptionReplaysConnection:seekApiConnection("id")}};const typeDefs=__webpack_require__("../node_modules/.pnpm/graphql-tag@2.12.7_graphql@16.14.2/node_modules/graphql-tag/lib/index.js").Ay`
  schema {
    query: Query
    mutation: Mutation
  }
...
`;var jsx_runtime=__webpack_require__("../node_modules/.pnpm/react@19.2.7/node_modules/react/jsx-runtime.js");const ApolloMockProvider=_ref=>{let{children,resolvers}=_ref;const client=(resolvers=>{const schema=(0,makeExecutableSchema._)({resolvers,typeDefs});return new ApolloClient.R({cache:new inMemoryCache.D({typePolicies:apolloTypePolicies()}),link:new link_schema.a({schema})})})(resolvers);return(0,jsx_runtime.jsx)(ApolloProvider.X,{client,children})}},"./src/private/MockComponentActions/MockComponentActions.tsx"(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{B:()=>MockComponentActions});var _IconEducation,_IconSocialGitHub,braid_design_system__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("../node_modules/.pnpm/braid-design-system@34.5.0_@types+react@19.2.14_babel-plugin-macros@3.1.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/braid-design-system/dist/lib/components/Stack/Stack.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("../node_modules/.pnpm/braid-design-system@34.5.0_@types+react@19.2.14_babel-plugin-macros@3.1.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/braid-design-system/dist/lib/components/icons/IconEducation/IconEducation.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("../node_modules/.pnpm/braid-design-system@34.5.0_@types+react@19.2.14_babel-plugin-macros@3.1.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/braid-design-system/dist/lib/components/icons/IconSocialGitHub/IconSocialGitHub.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("../node_modules/.pnpm/braid-design-system@34.5.0_@types+react@19.2.14_babel-plugin-macros@3.1.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/braid-design-system/dist/lib/components/Actions/Actions.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__("../node_modules/.pnpm/braid-design-system@34.5.0_@types+react@19.2.14_babel-plugin-macros@3.1.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/braid-design-system/dist/lib/components/ButtonLink/ButtonLink.mjs"),react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__("../node_modules/.pnpm/react@19.2.7/node_modules/react/jsx-runtime.js");const MockComponentActions=_ref=>{let{children,space,showStorybookAction,storybookPath,sourcePath}=_ref;return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(braid_design_system__WEBPACK_IMPORTED_MODULE_0__.B,{space,children:[children,showStorybookAction&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(braid_design_system__WEBPACK_IMPORTED_MODULE_3__.E,{size:"small",children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(braid_design_system__WEBPACK_IMPORTED_MODULE_4__.v,{href:`https://seek-oss.github.io/wingman/storybook/?path=${encodeURIComponent(storybookPath)}`,icon:_IconEducation||(_IconEducation=(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(braid_design_system__WEBPACK_IMPORTED_MODULE_1__.I,{})),rel:"noreferrer",target:"_blank",tone:"brandAccent",variant:"ghost",children:"Open in Storybook"}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(braid_design_system__WEBPACK_IMPORTED_MODULE_4__.v,{href:`https://github.com/seek-oss/wingman/tree/main/fe/${sourcePath}`,icon:_IconSocialGitHub||(_IconSocialGitHub=(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(braid_design_system__WEBPACK_IMPORTED_MODULE_2__.A,{})),rel:"noreferrer",target:"_blank",tone:"brandAccent",variant:"transparent",children:"Example code on GitHub"})]})]})}}}]);
//# sourceMappingURL=995.06255b3c.iframe.bundle.js.map