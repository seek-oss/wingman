"use strict";(self.webpackChunkwingman_fe=self.webpackChunkwingman_fe||[]).push([[485],{"./lib/components/ApolloMockProvider/ApolloMockProvider.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{f:()=>ApolloMockProvider});var jsx=__webpack_require__("../node_modules/.pnpm/@babel+runtime@7.25.6/node_modules/@babel/runtime/helpers/esm/jsx.js"),ApolloClient=__webpack_require__("../node_modules/.pnpm/@apollo+client@3.11.8_@types+react@18.3.11_graphql-ws@5.16.0_graphql@16.9.0__graphql@16.9.0_r_hwqnehycpe2vkz5apd4iiztwpa/node_modules/@apollo/client/core/ApolloClient.js"),inMemoryCache=__webpack_require__("../node_modules/.pnpm/@apollo+client@3.11.8_@types+react@18.3.11_graphql-ws@5.16.0_graphql@16.9.0__graphql@16.9.0_r_hwqnehycpe2vkz5apd4iiztwpa/node_modules/@apollo/client/cache/inmemory/inMemoryCache.js"),ApolloProvider=__webpack_require__("../node_modules/.pnpm/@apollo+client@3.11.8_@types+react@18.3.11_graphql-ws@5.16.0_graphql@16.9.0__graphql@16.9.0_r_hwqnehycpe2vkz5apd4iiztwpa/node_modules/@apollo/client/react/context/ApolloProvider.js"),link_schema=__webpack_require__("../node_modules/.pnpm/@apollo+client@3.11.8_@types+react@18.3.11_graphql-ws@5.16.0_graphql@16.9.0__graphql@16.9.0_r_hwqnehycpe2vkz5apd4iiztwpa/node_modules/@apollo/client/link/schema/index.js"),makeExecutableSchema=__webpack_require__("../node_modules/.pnpm/@graphql-tools+schema@10.0.6_graphql@16.9.0/node_modules/@graphql-tools/schema/esm/makeExecutableSchema.js");__webpack_require__("../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const readNestedStringField=(readField,fieldPath,from)=>{let field=from;for(const fieldName of fieldPath)field=readField(fieldName,field);return"string"==typeof field?field:void 0},infiniteScrollConnection=keyFields=>({fields:{edges:{merge:(existing,rawIncoming,_ref)=>{var _existing$slice;let{mergeObjects,readField,variables}=_ref;const reversed=Boolean(null==variables?void 0:variables.last),merged=null!==(_existing$slice=null==existing?void 0:existing.slice(0))&&void 0!==_existing$slice?_existing$slice:[],keyToIndex=Object.create(null),fieldPath=["node",...Array.isArray(keyFields)?keyFields:[keyFields,"value"]];null==existing||existing.forEach(((edge,index)=>{const key=readNestedStringField(readField,fieldPath,edge);key&&(keyToIndex[key]=index)}));return(reversed?rawIncoming.slice(0).reverse():rawIncoming).forEach((edge=>{const key=readNestedStringField(readField,fieldPath,edge);if(!key)return;const index=keyToIndex[key];"number"==typeof index?merged[index]=mergeObjects(merged[index],edge):(keyToIndex[key]=merged.length,merged.push(edge))})),merged}}}}),seekApiEdge=keyFields=>({keyFields:["node",Array.isArray(keyFields)?keyFields:[keyFields,["value"]]]}),seekApiObject=keyFields=>({keyFields:Array.isArray(keyFields)?keyFields:[keyFields,["value"]]}),apolloTypePolicies=function(){let{paginationPolicy="conservative"}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};const paginationKeyArgs="conservative"===paginationPolicy?["after","before","first","last"]:["first","last"],seekApiConnection="conservative"===paginationPolicy?()=>({}):infiniteScrollConnection;return{AdvertisementBranding:seekApiObject("id"),AdvertisementBrandingEdge:seekApiEdge("id"),AdvertisementBrandingsConnection:seekApiConnection("id"),ApplicationQuestionnaire:seekApiObject("id"),Candidate:seekApiObject("documentId"),CandidateProcessHistoryItem:seekApiObject("id"),CandidateProcessHistoryItemEdge:seekApiEdge("id"),CandidateProcessHistoryItemConnection:seekApiConnection("id"),CandidateProfile:{...seekApiObject("profileId"),fields:{seekProcessHistory:{keyArgs:paginationKeyArgs}}},Event:seekApiObject("id"),EventEdge:seekApiEdge("id"),EventsConnection:seekApiConnection("id"),HiringOrganization:seekApiObject("id"),HiringOrganizationEdge:seekApiEdge("id"),HiringOrganizationsConnection:seekApiConnection("id"),JobCategory:seekApiObject("id"),Location:seekApiObject("id"),PositionOpening:seekApiObject("documentId"),PositionOpeningEdge:seekApiEdge("documentId"),PositionOpeningsConnection:seekApiConnection("documentId"),PositionProfile:seekApiObject("profileId"),Query:{fields:{advertisementBrandings:{keyArgs:["filter","hirerId",...paginationKeyArgs]},events:{keyArgs:["filter","schemeId",...paginationKeyArgs]},hiringOrganizations:{keyArgs:["filter","schemeId",...paginationKeyArgs]},positionOpenings:{keyArgs:["filter","hirerId",...paginationKeyArgs]},webhookAttemptsForEvent:{keyArgs:["eventId","filter",...paginationKeyArgs]},webhookRequestsForSubscription:{keyArgs:["filter","subscriptionId",...paginationKeyArgs]},webhookSubscriptions:{keyArgs:["filter","schemeId",...paginationKeyArgs]}}},WebhookAttempt:seekApiObject("id"),WebhookRequest:seekApiObject(["requestId"]),WebhookRequestEdge:seekApiEdge(["requestId"]),WebhookRequestsConnection:seekApiConnection(["requestId"]),WebhookSubscription:{...seekApiObject("id"),fields:{webhookRequests:{keyArgs:["filter",...paginationKeyArgs]},webhookSubscriptionReplays:{keyArgs:["filter",...paginationKeyArgs]}}},WebhookSubscriptionEdge:seekApiEdge("id"),WebhookSubscriptionsConnection:seekApiConnection("id"),WebhookSubscriptionReplay:seekApiObject("id"),WebhookSubscriptionReplayEdge:seekApiEdge("id"),WebhookSubscriptionReplaysConnection:seekApiConnection("id")}};const typeDefs=__webpack_require__("../node_modules/.pnpm/graphql-tag@2.12.6_graphql@16.9.0/node_modules/graphql-tag/lib/index.js").Ay`
  schema {
    query: Query
    mutation: Mutation
  }
...
`,ApolloMockProvider=_ref=>{let{children,resolvers}=_ref;const client=(resolvers=>{const schema=(0,makeExecutableSchema._)({resolvers,typeDefs});return new ApolloClient.R({cache:new inMemoryCache.D({typePolicies:apolloTypePolicies()}),link:new link_schema.a({schema})})})(resolvers);return(0,jsx.A)(ApolloProvider.X,{client},void 0,children)}},"./lib/private/MockComponentActions/MockComponentActions.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{B:()=>MockComponentActions});var _IconEducation,_IconSocialGitHub,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("../node_modules/.pnpm/@babel+runtime@7.25.6/node_modules/@babel/runtime/helpers/esm/jsx.js"),braid_design_system__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("../node_modules/.pnpm/braid-design-system@33.0.0-next-20241010041150_@types+react@18.3.11_babel-plugin-macros@3.1.0_lwtmieyho5che2ep5gi76nw6nm/node_modules/braid-design-system/dist/lib/components/Stack/Stack.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("../node_modules/.pnpm/braid-design-system@33.0.0-next-20241010041150_@types+react@18.3.11_babel-plugin-macros@3.1.0_lwtmieyho5che2ep5gi76nw6nm/node_modules/braid-design-system/dist/lib/components/Actions/Actions.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__("../node_modules/.pnpm/braid-design-system@33.0.0-next-20241010041150_@types+react@18.3.11_babel-plugin-macros@3.1.0_lwtmieyho5che2ep5gi76nw6nm/node_modules/braid-design-system/dist/lib/components/ButtonLink/ButtonLink.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__("../node_modules/.pnpm/braid-design-system@33.0.0-next-20241010041150_@types+react@18.3.11_babel-plugin-macros@3.1.0_lwtmieyho5che2ep5gi76nw6nm/node_modules/braid-design-system/dist/lib/components/icons/IconEducation/IconEducation.mjs"),braid_design_system__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__("../node_modules/.pnpm/braid-design-system@33.0.0-next-20241010041150_@types+react@18.3.11_babel-plugin-macros@3.1.0_lwtmieyho5che2ep5gi76nw6nm/node_modules/braid-design-system/dist/lib/components/icons/IconSocialGitHub/IconSocialGitHub.mjs");__webpack_require__("../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const MockComponentActions=_ref=>{let{children,space,showStorybookAction,storybookPath,sourcePath}=_ref;return(0,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__.A)(braid_design_system__WEBPACK_IMPORTED_MODULE_2__.B,{space},void 0,children,showStorybookAction&&(0,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__.A)(braid_design_system__WEBPACK_IMPORTED_MODULE_3__.E,{size:"small"},void 0,(0,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__.A)(braid_design_system__WEBPACK_IMPORTED_MODULE_4__.v,{href:`https://seek-oss.github.io/wingman/storybook/?path=${encodeURIComponent(storybookPath)}`,icon:_IconEducation||(_IconEducation=(0,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__.A)(braid_design_system__WEBPACK_IMPORTED_MODULE_5__.I,{})),rel:"noreferrer",target:"_blank",tone:"brandAccent",variant:"ghost"},void 0,"Open in Storybook"),(0,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__.A)(braid_design_system__WEBPACK_IMPORTED_MODULE_4__.v,{href:`https://github.com/seek-oss/wingman/tree/master/fe/${sourcePath}`,icon:_IconSocialGitHub||(_IconSocialGitHub=(0,_babel_runtime_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__.A)(braid_design_system__WEBPACK_IMPORTED_MODULE_6__.A,{})),rel:"noreferrer",target:"_blank",tone:"brandAccent",variant:"transparent"},void 0,"Example code on GitHub")))}}}]);
//# sourceMappingURL=485.bbba3ca6.iframe.bundle.js.map