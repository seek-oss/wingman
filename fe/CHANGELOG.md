...
- Upgrade `sku` to v16 ([#1485](https://github.com/seek-oss/wingman/pull/1485))

  Bumps the `sku` toolchain to v16 and migrates to root resolution. There is no change to the published API.
