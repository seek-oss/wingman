...
type ApplicationMethod {
  ...
  """
  applicationEmail: Email @deprecated(reason: "This is always \`null\` and has been replaced by Application Export")
  """
...
type CandidateProfile {
  ...
  associatedPositionOpenings: [AssociatedPositionOpening!]! @deprecated(reason: "Use associatedPositionProfile")
  """
...
type PositionOpening {
  ...
  """
  positionProfiles: [PositionProfile!]! @deprecated(reason: "There is no guarantee all profiles will be returned. Use paginatedPositionProfiles instead.")
  """
  The party that owns the position opening.
...
union PostPositionPayload = PostPositionPayload_Conflict | PostPositionPayload_Success
...
union PostPositionProfileForOpeningPayload = PostPositionProfileForOpeningPayload_Conflict | PostPositionProfileForOpeningPayload_Success
...
"""
union UpdateWebhookSubscriptionDeliveryConfigurationPayload = UpdateWebhookSubscriptionDeliveryConfigurationPayload_Conflict | UpdateWebhookSubscriptionDeliveryConfigurationPayload_Success
