...
export type PositionProfileKeySpecifier = ('profileId' | 'positionOpening' | 'seekTypeCode' | 'positionTitle' | 'positionOrganizations' | 'seekHirerJobReference' | 'seekBillingReference' | 'positionUri' | 'positionFormattedDescriptions' | 'positionScheduleTypeCodes' | 'offeredRemunerationPackage' | 'seekAnzWorkTypeCode' | 'jobCategories' | 'positionLocation' | 'seekApplicationQuestionnaire' | 'seekVideo' | 'postingInstructions' | 'seekPartnerMetadata' | PositionProfileKeySpecifier)[];
...
export type PostedPositionProfileKeySpecifier = ('profileId' | 'positionOpening' | 'seekTypeCode' | 'positionTitle' | 'positionOrganizations' | 'seekHirerJobReference' | 'seekBillingReference' | 'positionUri' | 'positionFormattedDescriptions' | 'positionScheduleTypeCodes' | 'offeredRemunerationPackage' | 'seekAnzWorkTypeCode' | 'jobCategories' | 'positionLocation' | 'seekApplicationQuestionnaire' | 'seekVideo' | 'postingInstructions' | 'seekPartnerMetadata' | PostedPositionProfileKeySpecifier)[];
...
export type UnpostedPositionProfileKeySpecifier = ('profileId' | 'profileName' | 'positionOpening' | 'seekTypeCode' | 'positionTitle' | 'positionOrganizations' | 'seekHirerJobReference' | 'seekBillingReference' | 'positionUri' | 'positionFormattedDescriptions' | 'positionScheduleTypeCodes' | 'offeredRemunerationPackage' | 'seekAnzWorkTypeCode' | 'jobCategories' | 'positionLocation' | 'seekApplicationQuestionnaire' | 'seekVideo' | 'postingInstructions' | 'seekPartnerMetadata' | UnpostedPositionProfileKeySpecifier)[];
