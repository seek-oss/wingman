...
export type AddressKeySpecifier = ('city' | 'countryCode' | 'countrySubDivisions' | 'extendedLines' | 'formattedAddress' | 'geoLocation' | 'line' | 'postalCode' | AddressKeySpecifier)[];
...
export type AdvertisementBrandingKeySpecifier = ('hirer' | 'id' | 'images' | 'name' | AdvertisementBrandingKeySpecifier)[];
...
export type AdvertisementBrandingsConnectionKeySpecifier = ('brandManagementUrl' | 'edges' | 'pageInfo' | AdvertisementBrandingsConnectionKeySpecifier)[];
...
export type ApplicationLibraryQuestionKeySpecifier = ('id' | 'preferenceSelection' | 'responseChoice' | 'responseTypeCode' | 'text' | ApplicationLibraryQuestionKeySpecifier)[];
...
export type ApplicationLibraryQuestionChoiceKeySpecifier = ('id' | 'text' | ApplicationLibraryQuestionChoiceKeySpecifier)[];
export type ApplicationLibraryQuestionChoiceFieldPolicy = {
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	text?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ApplicationLibraryQuestionPreferenceSelectionKeySpecifier = ('message' | 'typeCode' | ApplicationLibraryQuestionPreferenceSelectionKeySpecifier)[];
export type ApplicationLibraryQuestionPreferenceSelectionFieldPolicy = {
	message?: FieldPolicy<any> | FieldReadFunction<any>,
	typeCode?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ApplicationLibraryQuestionSuggestionKeySpecifier = ('applicationLibraryQuestion' | 'id' | ApplicationLibraryQuestionSuggestionKeySpecifier)[];
...
export type ApplicationMethodKeySpecifier = ('applicationEmail' | 'applicationUri' | ApplicationMethodKeySpecifier)[];
...
export type ApplicationPrivacyConsentKeySpecifier = ('componentTypeCode' | 'descriptionHtml' | 'id' | 'privacyPolicyUrl' | 'value' | ApplicationPrivacyConsentKeySpecifier)[];
...
export type ApplicationQuestionKeySpecifier = ('applicationLibraryQuestion' | 'componentTypeCode' | 'id' | 'questionHtml' | 'responseChoice' | 'responseTypeCode' | 'sourceCode' | 'value' | ApplicationQuestionKeySpecifier)[];
...
export type ApplicationQuestionAnswerKeySpecifier = ('answer' | 'choice' | ApplicationQuestionAnswerKeySpecifier)[];
...
export type ApplicationQuestionChoiceKeySpecifier = ('applicationLibraryQuestionChoice' | 'id' | 'preferredIndicator' | 'selectedIndicator' | 'text' | 'value' | ApplicationQuestionChoiceKeySpecifier)[];
...
export type ApplicationQuestionResponseKeySpecifier = ('answers' | 'component' | 'componentTypeCode' | 'score' | ApplicationQuestionResponseKeySpecifier)[];
...
export type ApplicationQuestionnaireKeySpecifier = ('components' | 'hirer' | 'id' | ApplicationQuestionnaireKeySpecifier)[];
export type ApplicationQuestionnaireFieldPolicy = {
	components?: FieldPolicy<any> | FieldReadFunction<any>,
	hirer?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ApplicationQuestionnaireComponentKeySpecifier = ('componentTypeCode' | 'id' | 'value' | ApplicationQuestionnaireComponentKeySpecifier)[];
...
export type AssociatedPositionOpeningKeySpecifier = ('candidateAppliedIndicator' | 'positionOpening' | 'positionOpeningId' | 'positionUri' | AssociatedPositionOpeningKeySpecifier)[];
...
export type AttachmentKeySpecifier = ('descriptions' | 'id' | 'seekRole' | 'seekRoleCode' | 'url' | AttachmentKeySpecifier)[];
...
export type CandidateKeySpecifier = ('distributionGuidelines' | 'documentId' | 'person' | 'profiles' | 'seekPrimaryEmailAddress' | CandidateKeySpecifier)[];
...
export type CandidateApplicationCreatedEventKeySpecifier = ('candidate' | 'candidateApplicationProfile' | 'candidateApplicationProfileId' | 'candidateId' | 'createDateTime' | 'id' | 'schemeId' | 'typeCode' | 'webhookAttempts' | CandidateApplicationCreatedEventKeySpecifier)[];
...
export type CandidatePersonKeySpecifier = ('communication' | 'name' | CandidatePersonKeySpecifier)[];
...
export type CandidateProcessHistoryItemKeySpecifier = ('action' | 'actionDate' | 'candidateProfile' | 'id' | 'positionProfile' | 'primaryParties' | 'seekSource' | 'status' | CandidateProcessHistoryItemKeySpecifier)[];
...
export type CandidateProcessPartyKeySpecifier = ('organization' | 'person' | CandidateProcessPartyKeySpecifier)[];
...
export type CandidateProfileKeySpecifier = ('associatedPositionOpenings' | 'associatedPositionProfile' | 'attachments' | 'candidate' | 'candidateSources' | 'certifications' | 'createDateTime' | 'education' | 'employment' | 'positionPreferences' | 'profileId' | 'qualifications' | 'seekActions' | 'seekProcessHistory' | 'seekQuestionnaireSubmission' | 'updateDateTime' | CandidateProfileKeySpecifier)[];
...
export type CandidateProfilePurchasedEventKeySpecifier = ('candidateProfile' | 'candidateProfileId' | 'createDateTime' | 'id' | 'schemeId' | 'typeCode' | 'webhookAttempts' | CandidateProfilePurchasedEventKeySpecifier)[];
...
export type CertificationKeySpecifier = ('descriptions' | 'effectiveTimePeriod' | 'issueDate' | 'issued' | 'issuingAuthority' | 'name' | CertificationKeySpecifier)[];
...
export type CommunicationKeySpecifier = ('address' | 'email' | 'phone' | 'seekDoNotContactIndicator' | CommunicationKeySpecifier)[];
...
export type CreateCandidateProcessHistoryItemPayload_ConflictKeySpecifier = ('candidateProfile' | 'conflictingCandidateProcessHistoryItem' | CreateCandidateProcessHistoryItemPayload_ConflictKeySpecifier)[];
...
export type CurrencyMinorUnitKeySpecifier = ('currency' | 'value' | CurrencyMinorUnitKeySpecifier)[];
...
export type EducationAttendanceKeySpecifier = ('descriptions' | 'educationDegrees' | 'institution' | EducationAttendanceKeySpecifier)[];
...
export type EducationDegreeKeySpecifier = ('date' | 'degreeGrantedStatus' | 'name' | EducationDegreeKeySpecifier)[];
...
export type EventKeySpecifier = ('createDateTime' | 'id' | 'schemeId' | 'typeCode' | 'webhookAttempts' | EventKeySpecifier)[];
...
export type HirerRelationshipChangedEventKeySpecifier = ('createDateTime' | 'hirer' | 'hirerId' | 'id' | 'schemeId' | 'typeCode' | 'webhookAttempts' | HirerRelationshipChangedEventKeySpecifier)[];
...
export type HiringOrganizationKeySpecifier = ('id' | 'name' | 'seekAnzAdvertiserId' | 'seekApiCapabilities' | HiringOrganizationKeySpecifier)[];
...
export type HiringOrganizationApiCapabilitiesKeySpecifier = ('applicationMethodCodes' | 'relationshipTypeCodes' | HiringOrganizationApiCapabilitiesKeySpecifier)[];
...
export type JobCategoryKeySpecifier = ('children' | 'id' | 'name' | 'parent' | JobCategoryKeySpecifier)[];
...
export type JobCategorySuggestionChoiceKeySpecifier = ('confidence' | 'jobCategory' | JobCategorySuggestionChoiceKeySpecifier)[];
...
export type LocationKeySpecifier = ('children' | 'contextualName' | 'countryCode' | 'id' | 'name' | 'parent' | LocationKeySpecifier)[];
...
export type MutationKeySpecifier = ('_empty' | 'closePostedPositionProfile' | 'createApplicationQuestionnaire' | 'createCandidateProcessHistoryItem' | 'createPositionOpening' | 'createUnpostedPositionProfileForOpening' | 'createWebhookSubscription' | 'deleteCandidateProcessHistoryItem' | 'deletePositionOpening' | 'deleteUnpostedPositionProfile' | 'deleteUploadedCandidate' | 'deleteWebhookSubscription' | 'postPosition' | 'postPositionProfileForOpening' | 'replayWebhookSubscription' | 'updateCandidateProcessHistoryItem' | 'updatePositionOpeningPersonContacts' | 'updatePositionOpeningStatus' | 'updatePostedPositionProfile' | 'updateUnpostedPositionProfile' | 'updateUploadedCandidatePerson' | 'updateUploadedCandidateProfileActions' | 'updateUploadedCandidateProfileDates' | 'updateUploadedCandidateProfilePositionPreferences' | 'updateWebhookSubscriptionDeliveryConfiguration' | 'updateWebhookSubscriptionSigningConfiguration' | 'uploadCandidate' | MutationKeySpecifier)[];
...
export type PartnerOrganizationKeySpecifier = ('credentialSelfServiceApprovedIndicator' | 'name' | PartnerOrganizationKeySpecifier)[];
export type PartnerOrganizationFieldPolicy = {
	credentialSelfServiceApprovedIndicator?: FieldPolicy<any> | FieldReadFunction<any>,
	name?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type PersonNameKeySpecifier = ('family' | 'formattedName' | 'given' | PersonNameKeySpecifier)[];
...
export type PositionFormattedDescriptionKeySpecifier = ('content' | 'descriptionId' | PositionFormattedDescriptionKeySpecifier)[];
...
export type PositionHistoryKeySpecifier = ('current' | 'descriptions' | 'end' | 'start' | 'title' | PositionHistoryKeySpecifier)[];
...
export type PositionOpeningKeySpecifier = ('documentId' | 'paginatedPositionProfiles' | 'positionProfiles' | 'postingRequester' | 'seekPartnerMetadata' | 'statusCode' | PositionOpeningKeySpecifier)[];
...
export type PositionProfileKeySpecifier = ('jobCategories' | 'offeredRemunerationPackage' | 'positionFormattedDescriptions' | 'positionLocation' | 'positionOpening' | 'positionOrganizations' | 'positionScheduleTypeCodes' | 'positionTitle' | 'positionUri' | 'postingInstructions' | 'profileId' | 'seekAnzWorkTypeCode' | 'seekApplicationQuestionnaire' | 'seekBillingReference' | 'seekCreatedBySelfIndicator' | 'seekHirerJobReference' | 'seekPartnerMetadata' | 'seekTypeCode' | 'seekVideo' | PositionProfileKeySpecifier)[];
...
export type PositionProfileClosedEventKeySpecifier = ('createDateTime' | 'id' | 'positionProfile' | 'positionProfileId' | 'schemeId' | 'typeCode' | 'webhookAttempts' | PositionProfileClosedEventKeySpecifier)[];
...
export type PositionProfileConnectionKeySpecifier = ('edges' | 'pageInfo' | PositionProfileConnectionKeySpecifier)[];
export type PositionProfileConnectionFieldPolicy = {
	edges?: FieldPolicy<any> | FieldReadFunction<any>,
	pageInfo?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PositionProfileEdgeKeySpecifier = ('cursor' | 'node' | PositionProfileEdgeKeySpecifier)[];
export type PositionProfileEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PositionProfilePostedEventKeySpecifier = ('createDateTime' | 'id' | 'positionProfile' | 'positionProfileId' | 'schemeId' | 'typeCode' | 'webhookAttempts' | PositionProfilePostedEventKeySpecifier)[];
...
export type PostedPositionProfileKeySpecifier = ('jobCategories' | 'offeredRemunerationPackage' | 'positionFormattedDescriptions' | 'positionLocation' | 'positionOpening' | 'positionOrganizations' | 'positionScheduleTypeCodes' | 'positionTitle' | 'positionUri' | 'postingInstructions' | 'profileId' | 'seekAnzWorkTypeCode' | 'seekApplicationQuestionnaire' | 'seekApplicationUri' | 'seekBillingReference' | 'seekCreatedBySelfIndicator' | 'seekHirerJobReference' | 'seekPartnerMetadata' | 'seekTypeCode' | 'seekVideo' | PostedPositionProfileKeySpecifier)[];
...
export type PostedPositionProfilePreviewKeySpecifier = ('previewUri' | PostedPositionProfilePreviewKeySpecifier)[];
export type PostedPositionProfilePreviewFieldPolicy = {
	previewUri?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PostingInstructionKeySpecifier = ('applicationMethods' | 'branding' | 'brandingId' | 'end' | 'seekAnzAdvertisementType' | 'start' | PostingInstructionKeySpecifier)[];
...
export type PostingRequesterKeySpecifier = ('id' | 'name' | 'personContacts' | 'roleCode' | 'seekAnzAdvertiserId' | PostingRequesterKeySpecifier)[];
...
export type QueryKeySpecifier = ('_unstable_advertisementProducts' | 'advertisementBranding' | 'advertisementBrandings' | 'applicationLibraryQuestionSuggestions' | 'applicationQuestionnaire' | 'candidate' | 'candidateProcessHistoryItem' | 'candidateProfile' | 'event' | 'events' | 'hiringOrganization' | 'hiringOrganizations' | 'jobCategories' | 'jobCategory' | 'jobCategorySuggestions' | 'location' | 'locationSuggestions' | 'nearestLocations' | 'positionOpening' | 'positionOpenings' | 'positionProfile' | 'postedPositionProfilePreview' | 'seekAnzAdvertiser' | 'seekAnzHirerAdvertisementCreationProducts' | 'seekAnzHirerAdvertisementModificationProducts' | 'seekAnzHirerAdvertisementModificationProductsAlt' | 'self' | 'version' | 'webhookAttemptsForEvent' | 'webhookRequest' | 'webhookRequestsForSubscription' | 'webhookSubscription' | 'webhookSubscriptionReplay' | 'webhookSubscriptions' | QueryKeySpecifier)[];
export type QueryFieldPolicy = {
	...
	applicationLibraryQuestionSuggestions?: FieldPolicy<any> | FieldReadFunction<any>,
	applicationQuestionnaire?: FieldPolicy<any> | FieldReadFunction<any>,
	candidate?: FieldPolicy<any> | FieldReadFunction<any>,
	candidateProcessHistoryItem?: FieldPolicy<any> | FieldReadFunction<any>,
	candidateProfile?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type RemunerationAmountKeySpecifier = ('currency' | 'value' | RemunerationAmountKeySpecifier)[];
export type RemunerationAmountFieldPolicy = {
	currency?: FieldPolicy<any> | FieldReadFunction<any>,
	value?: FieldPolicy<any> | FieldReadFunction<any>
};
export type RemunerationPackageKeySpecifier = ('basisCode' | 'descriptions' | 'ranges' | RemunerationPackageKeySpecifier)[];
...
export type RemunerationRangeKeySpecifier = ('intervalCode' | 'maximumAmount' | 'minimumAmount' | RemunerationRangeKeySpecifier)[];
...
export type SeekAnzAdProductKeySpecifier = ('advertisementTypeCode' | 'checkoutEstimate' | 'description' | 'enabledIndicator' | 'features' | 'messages' | 'name' | 'price' | SeekAnzAdProductKeySpecifier)[];
...
export type SeekAnzAdProductCheckoutEstimateKeySpecifier = ('contractConsumption' | 'paymentDueExcludingTax' | 'summary' | SeekAnzAdProductCheckoutEstimateKeySpecifier)[];
...
export type SeekAnzAdProductMessageKeySpecifier = ('content' | 'severityCode' | 'typeCode' | 'visibilityCode' | SeekAnzAdProductMessageKeySpecifier)[];
...
export type SeekAnzAdProductPriceKeySpecifier = ('amountExcludingTax' | 'summary' | 'taxedIndicator' | 'visibleForHirerIndicator' | SeekAnzAdProductPriceKeySpecifier)[];
...
export type SeekVideoKeySpecifier = ('seekAnzPositionCode' | 'url' | SeekVideoKeySpecifier)[];
export type SeekVideoFieldPolicy = {
	seekAnzPositionCode?: FieldPolicy<any> | FieldReadFunction<any>,
	url?: FieldPolicy<any> | FieldReadFunction<any>
};
export type SelfOrganizationsKeySpecifier = ('hirer' | 'partner' | SelfOrganizationsKeySpecifier)[];
export type SelfOrganizationsFieldPolicy = {
	hirer?: FieldPolicy<any> | FieldReadFunction<any>,
	partner?: FieldPolicy<any> | FieldReadFunction<any>
};
export type SpecifiedPersonKeySpecifier = ('communication' | 'name' | 'roleCode' | SpecifiedPersonKeySpecifier)[];
export type SpecifiedPersonFieldPolicy = {
	communication?: FieldPolicy<any> | FieldReadFunction<any>,
	name?: FieldPolicy<any> | FieldReadFunction<any>,
	roleCode?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UnpostedPositionProfileKeySpecifier = ('jobCategories' | 'offeredRemunerationPackage' | 'positionFormattedDescriptions' | 'positionLocation' | 'positionOpening' | 'positionOrganizations' | 'positionScheduleTypeCodes' | 'positionTitle' | 'positionUri' | 'postingInstructions' | 'profileId' | 'profileName' | 'seekAnzWorkTypeCode' | 'seekApplicationQuestionnaire' | 'seekBillingReference' | 'seekCreatedBySelfIndicator' | 'seekHirerJobReference' | 'seekPartnerMetadata' | 'seekTypeCode' | 'seekVideo' | UnpostedPositionProfileKeySpecifier)[];
...
export type WebhookAttemptKeySpecifier = ('createDateTime' | 'event' | 'id' | 'webhookRequest' | 'webhookSubscription' | WebhookAttemptKeySpecifier)[];
...
export type WebhookRequestKeySpecifier = ('attempts' | 'createDateTime' | 'descriptionCode' | 'latencyMs' | 'requestId' | 'statusCode' | 'webhookSubscription' | WebhookRequestKeySpecifier)[];
...
export type WebhookSubscriptionKeySpecifier = ('createDateTime' | 'eventTypeCode' | 'hirer' | 'hirerId' | 'id' | 'maxEventsPerAttempt' | 'schemeId' | 'signingAlgorithmCode' | 'updateDateTime' | 'url' | 'webhookRequests' | 'webhookSubscriptionReplays' | WebhookSubscriptionKeySpecifier)[];
...
export type WebhookSubscriptionReplayKeySpecifier = ('createDateTime' | 'id' | 'request' | 'statusCode' | 'updateDateTime' | 'webhookSubscription' | WebhookSubscriptionReplayKeySpecifier)[];
...
export type WebhookSubscriptionReplayByIdRequestKeySpecifier = ('eventIds' | 'typeCode' | WebhookSubscriptionReplayByIdRequestKeySpecifier)[];
export type WebhookSubscriptionReplayByIdRequestFieldPolicy = {
	eventIds?: FieldPolicy<any> | FieldReadFunction<any>,
	typeCode?: FieldPolicy<any> | FieldReadFunction<any>
};
export type WebhookSubscriptionReplayByRangeRequestKeySpecifier = ('afterDateTime' | 'beforeDateTime' | 'hirer' | 'replayDeliveredEventsIndicator' | 'typeCode' | WebhookSubscriptionReplayByRangeRequestKeySpecifier)[];
...
export type WebhookSubscriptionReplayRequestKeySpecifier = ('typeCode' | WebhookSubscriptionReplayRequestKeySpecifier)[];
...
export type _unstable_AdvertisementProductKeySpecifier = ('description' | 'features' | 'id' | 'label' | 'payment' | 'price' | 'selected' | 'sellingPoints' | _unstable_AdvertisementProductKeySpecifier)[];
...
export type _unstable_AdvertisementProductFeaturesKeySpecifier = ('branding' | 'bulletPoints' | _unstable_AdvertisementProductFeaturesKeySpecifier)[];
export type _unstable_AdvertisementProductFeaturesFieldPolicy = {
	branding?: FieldPolicy<any> | FieldReadFunction<any>,
	bulletPoints?: FieldPolicy<any> | FieldReadFunction<any>
};
export type _unstable_AdvertisementProductFeaturesBrandingKeySpecifier = ('coverImage' | 'logo' | _unstable_AdvertisementProductFeaturesBrandingKeySpecifier)[];
...
export type _unstable_AdvertisementProductFeaturesBulletPointsKeySpecifier = ('limit' | _unstable_AdvertisementProductFeaturesBulletPointsKeySpecifier)[];
export type _unstable_AdvertisementProductFeaturesBulletPointsFieldPolicy = {
	limit?: FieldPolicy<any> | FieldReadFunction<any>
};
export type _unstable_AdvertisementProductPaymentDetailsKeySpecifier = ('summary' | 'summaryHtml' | _unstable_AdvertisementProductPaymentDetailsKeySpecifier)[];
export type _unstable_AdvertisementProductPaymentDetailsFieldPolicy = {
	summary?: FieldPolicy<any> | FieldReadFunction<any>,
	summaryHtml?: FieldPolicy<any> | FieldReadFunction<any>
};
export type _unstable_AdvertisementProductPriceDetailsKeySpecifier = ('summary' | _unstable_AdvertisementProductPriceDetailsKeySpecifier)[];
export type _unstable_AdvertisementProductPriceDetailsFieldPolicy = {
	summary?: FieldPolicy<any> | FieldReadFunction<any>
};
export type _unstable_AdvertisementProductSellingPointKeySpecifier = ('text' | _unstable_AdvertisementProductSellingPointKeySpecifier)[];
export type _unstable_AdvertisementProductSellingPointFieldPolicy = {
	text?: FieldPolicy<any> | FieldReadFunction<any>
};
export type _unstable_AdvertisementProductsKeySpecifier = ('information' | 'products' | _unstable_AdvertisementProductsKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	ApplicationLibraryQuestion?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ApplicationLibraryQuestionKeySpecifier | (() => undefined | ApplicationLibraryQuestionKeySpecifier),
		fields?: ApplicationLibraryQuestionFieldPolicy,
	},
	ApplicationLibraryQuestionChoice?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ApplicationLibraryQuestionChoiceKeySpecifier | (() => undefined | ApplicationLibraryQuestionChoiceKeySpecifier),
		fields?: ApplicationLibraryQuestionChoiceFieldPolicy,
	},
	ApplicationLibraryQuestionPreferenceSelection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ApplicationLibraryQuestionPreferenceSelectionKeySpecifier | (() => undefined | ApplicationLibraryQuestionPreferenceSelectionKeySpecifier),
		fields?: ApplicationLibraryQuestionPreferenceSelectionFieldPolicy,
	},
	ApplicationLibraryQuestionSuggestion?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ApplicationLibraryQuestionSuggestionKeySpecifier | (() => undefined | ApplicationLibraryQuestionSuggestionKeySpecifier),
	...
	PositionProfileConnection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PositionProfileConnectionKeySpecifier | (() => undefined | PositionProfileConnectionKeySpecifier),
		fields?: PositionProfileConnectionFieldPolicy,
	},
	PositionProfileEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PositionProfileEdgeKeySpecifier | (() => undefined | PositionProfileEdgeKeySpecifier),
	...
	PostedPositionProfilePreview?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PostedPositionProfilePreviewKeySpecifier | (() => undefined | PostedPositionProfilePreviewKeySpecifier),
	...
	WebhookSubscriptionReplayByIdRequest?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | WebhookSubscriptionReplayByIdRequestKeySpecifier | (() => undefined | WebhookSubscriptionReplayByIdRequestKeySpecifier),
		fields?: WebhookSubscriptionReplayByIdRequestFieldPolicy,
	},
	WebhookSubscriptionReplayByRangeRequest?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | WebhookSubscriptionReplayByRangeRequestKeySpecifier | (() => undefined | WebhookSubscriptionReplayByRangeRequestKeySpecifier),
	...
	WebhookSubscriptionReplayRequest?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | WebhookSubscriptionReplayRequestKeySpecifier | (() => undefined | WebhookSubscriptionReplayRequestKeySpecifier),
	...
	_unstable_AdvertisementProduct?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductKeySpecifier | (() => undefined | _unstable_AdvertisementProductKeySpecifier),
		fields?: _unstable_AdvertisementProductFieldPolicy,
	},
	_unstable_AdvertisementProductFeatures?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductFeaturesKeySpecifier | (() => undefined | _unstable_AdvertisementProductFeaturesKeySpecifier),
		fields?: _unstable_AdvertisementProductFeaturesFieldPolicy,
	},
	_unstable_AdvertisementProductFeaturesBranding?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductFeaturesBrandingKeySpecifier | (() => undefined | _unstable_AdvertisementProductFeaturesBrandingKeySpecifier),
		fields?: _unstable_AdvertisementProductFeaturesBrandingFieldPolicy,
	},
	_unstable_AdvertisementProductFeaturesBulletPoints?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductFeaturesBulletPointsKeySpecifier | (() => undefined | _unstable_AdvertisementProductFeaturesBulletPointsKeySpecifier),
		fields?: _unstable_AdvertisementProductFeaturesBulletPointsFieldPolicy,
	},
	_unstable_AdvertisementProductPaymentDetails?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductPaymentDetailsKeySpecifier | (() => undefined | _unstable_AdvertisementProductPaymentDetailsKeySpecifier),
		fields?: _unstable_AdvertisementProductPaymentDetailsFieldPolicy,
	},
	_unstable_AdvertisementProductPriceDetails?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductPriceDetailsKeySpecifier | (() => undefined | _unstable_AdvertisementProductPriceDetailsKeySpecifier),
		fields?: _unstable_AdvertisementProductPriceDetailsFieldPolicy,
	},
	_unstable_AdvertisementProductSellingPoint?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductSellingPointKeySpecifier | (() => undefined | _unstable_AdvertisementProductSellingPointKeySpecifier),
	...
	_unstable_AdvertisementProducts?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | _unstable_AdvertisementProductsKeySpecifier | (() => undefined | _unstable_AdvertisementProductsKeySpecifier),
