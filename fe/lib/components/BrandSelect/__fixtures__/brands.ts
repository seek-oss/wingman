...
export const mockPaginatedBrandsFirstPage = (pageSize: number) => ({
  pageInfo: {
    hasNextPage: pageSize < mockBrands.length,
    hasPreviousPage: false,
...
export const mockPaginatedBrandsSecondPage = (pageSize: number) => ({
  pageInfo: {
    hasNextPage: pageSize * 2 < mockBrands.length,
    hasPreviousPage: true,
    startCursor: startCursorPaginatedBrandsSecondPage,
    endCursor: endCursorPaginatedBrandsSecondPage,
  },
  edges: mockBrands.slice(pageSize, pageSize * 2),
});

export const mockPaginatedBrandsLastPage = (pageSize: number) => ({
  pageInfo: {
    hasNextPage: pageSize * 3 < mockBrands.length,
    hasPreviousPage: true,
    startCursor: startCursorPaginatedBrandsLastPage,
    endCursor: endCursorPaginatedBrandsLastPage,
  },
  edges: mockBrands.slice(pageSize * 2, pageSize * 3),
});
